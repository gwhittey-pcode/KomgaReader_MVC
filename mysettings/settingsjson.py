...
settings_json_sync = json.dumps(
    [
        {"type": "title", "title": "Sync Settings"},
        {
            "type": "path",
...
settings_json_server = json.dumps(
    [
        ...
        #  'key':     'use_api_key'},
        {
            "type": "string",
            "title": "X-Auth-Token",
            "desc": "X-Auth-Token Key for server",
            "section": "General",
            "key": "api_key",
        },
        {
...
settings_json_dispaly = json.dumps(
    [
        {"type": "title", "title": "Settings for how comic reader behaves"},
        {
            "type": "bool",
            "title": "Right to Left",
...
tap_options = [
    ...
    "Return to Comic List Screen",
    "Go to Reading Lists Screen",
    "Open NavBar",
    "None",
]
...
settings_json_hotkeys = json.dumps(
    [
        {"type": "title", "title": "Keyboard Hotkeys"},
        {
            "type": "hotkeys",
            "title": "Next Page",
