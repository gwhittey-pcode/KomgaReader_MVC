...
from View.Widgets.myfitimage import MyFitImage
...
class MySmartTileImage(RectangularRippleBehavior, ButtonBehavior, MyFitImage):
    """Implements the tile image."""


class MySmartTileOverlayBox(MDBoxLayout):
    """Implements a container for custom widgets to be added to the tile."""


class MyMDSmartTile(MDRelativeLayout, ThemableBehavior):
    """
    ...
    def add_widget(self, widget, *args, **kwargs):
        if isinstance(widget, (MySmartTileImage, MySmartTileOverlayBox)):
